...
namespace Manage_School_Data.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(MVC_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,Grade,Class")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Grade,Class")] StudentModel studentModel)
        {
