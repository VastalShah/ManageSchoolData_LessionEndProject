...
namespace Manage_School_Data.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public SubjectController(MVC_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,SubjectName,SubjectCode")] SubjectModel subjectModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,SubjectName,SubjectCode")] SubjectModel subjectModel)
        {
